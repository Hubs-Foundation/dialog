...
class Room extends EventEmitter
{
	...
	static async create({ mediasoupWorkers, roomId, authKey })
	{
		...
		for (const worker of mediasoupWorkers)
		{
			...
			logger.info(" --- rouer.id:", router.id)
		...
		logger.info("firstRouter - audioLevelObserver: ", audioLevelObserver)
		logger.info("firstRouterId: ", firstRouterId)
		logger.info("firstRouter: ", firstRouter)

		const bot = await Bot.create(firstRouter);
