...
class Room extends EventEmitter
{
	...
	static async create({ mediasoupWorkers, roomId, authKey })
	{
		...
		logger.warn(" using hardcoded 25 for roomReq to practically disable it -- TODO: request room with roomSize for different tiers...ie. request the lesser of (roomSize, workerPeerCapacity)")
