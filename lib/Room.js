...
class Room extends EventEmitter
{
	...
	async _getRouterId()
	{
		...
		logger.info("this._arr_unusedMediasoupWorkers.size", this._arr_unusedMediasoupWorkers.size)

		if (this._arr_unusedMediasoupWorkers.length > 0){
			//try to find an available worker among the unused
			const unusedWorkers = Array.from( this._arr_unusedMediasoupWorkers.keys() );
