...
class Room extends EventEmitter
{
	...
	static async getLeastLoadedWorker(mediasoupWorkers){
		...
		const sortedWorkers = new Map([ ...sortedWorkers.entries() ].sort(
			(a, b) => a[1] - b[1]));
		logger.warn("sortedWorkers", sortedWorkers)
		const LeastUsedWorkerPid = sortedWorkerLoads.keys().next().value;
