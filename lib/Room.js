...
class Room extends EventEmitter
{
	 ...
	 */
	static async create({ mediasoupWorkers, roomId, authKey, capRes=0 })
	{
		...
		if (capRes==0){
			logger.warn("roomId <%s> didn't reserve any capacity (capRes==%s) -- room overload possible", roomId, capRes)
		}
		utils.workerLoadMan.addRoomReq(worker._pid, roomId, capRes)
	...
	constructor({ roomId, capRes,protooRoom, mediasoupRouters, audioLevelObserver, arr_unusedMediasoupWorkers, inuseMediasoupWorkers, bot, authKey })
	{
		super();
