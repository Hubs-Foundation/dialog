...
class utils{
	...
	static getLeastLoadedWorkerIdx(mediasoupWorkers){
        ...
        //TODO (after "roomReq" feature's implemeneted):
        //  drop _peer because _room should always be greater than _peer 
        ...
        return minCnt_room>minCnt_peer?minWorkerIdx_room:minWorkerIdx_peer
	}
}
